...
var options = {
    ...
    colors: ['#2786f1', '#522c8f', '#ec344c', '#c26316'],
    legend: {
        position: 'right',
        offsetY: 40
    },
...
var options = {
    ...
    colors: ['#2786f1', '#6b3baa', '#c26316', '#27ebb0'],
    yaxis: {
        labels: {
            formatter: (val) => {
                return val / 1000 + 'K'
...
var options = {
    ...
    colors: ['#2786f1', '#522c8f', '#6b3baa', '#963b68', '#ec344c', "#f59440","#287F71", "#73bbe2"],
    plotOptions: {
        bar: {
            columnWidth: '45%',
            distributed: true,
