                    ...
                    <div class="card card-h-full">
                        <div class="inner-box card-body p-4">
                            ...
                            <ul class="flex-grow-1 plan-stats list-unstyled">
                                <li><i data-feather="check" class="check-icon text-primary me-2"></i>1 products</li>
                                <li><i data-feather="check" class="check-icon text-primary me-2"></i>Up to 500 subscribers</li>
                                <li><i data-feather="check" class="check-icon text-primary me-2"></i>Basic analytics</li>
                                <li><i data-feather="check" class="check-icon text-primary me-2"></i>12-hour support response time</li>
                            </ul>
                    ...
                    <div class="card card-h-full border-primary border shadow-none">
                        <div class="inner-box card-body p-4">
                            ...
                            <ul class="flex-grow-1 plan-stats list-unstyled">
                                ...
                                <li><i data-feather="check" class="check-icon text-primary me-2"></i>Basic analytics</li>
                                <li><i data-feather="check" class="check-icon text-primary me-2"></i>24-hour support response time</li>
                            </ul>
                    ...
                    <div class="card card-h-full">
                        <div class="inner-box card-body p-4">
                            ...
                            <ul class="flex-grow-1 plan-stats list-unstyled">
                                ...
                                <li><i data-feather="check" class="check-icon text-primary me-2"></i>48-hour support response </li>
                            </ul>
                    ...
                    <div class="card card-h-full">
                        <div class="inner-box card-body p-4">
                            ...
                            <div class="plan-header">
                                ...
                                <p class="plan-subtitle">Personalized subscribers solution for teams of any size, providing flexibility to adapt to specific project seamless and development workflow.</p>
                            </div>
